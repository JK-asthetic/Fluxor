...
from gui.widgets.py_displaydirectory import DirectoryContentsWidget 
import sys
import os
...
class SetupMainWindow:
    ...
    add_left_menus = [
        ...
        },
        {
            ...
            "btn_id" : "File_Classify",
            "btn_text" : "AI File Classifier",
            "btn_tooltip" : "AI File Classifier",
            "show_top" : True,
            "is_active" : False
        },
        {
            ...
            "btn_id" : "rename_file",
            "btn_text" : "AI File Renaming",
            "btn_tooltip" : "AI File Renaming",
            "show_top" : True,
            "is_active" : False
        },
        {
            "btn_icon" : "icon_folder_open.svg",
            "btn_id" : "Segement_Files",
            "btn_text" : "Classify File Based On Type",
            "btn_tooltip" : "Classify File Based On Type",
            "show_top" : True,
            "is_active" : False
        },
        {
            "btn_icon" : "icon_folder_open.svg",
            "btn_id" : "chat_bot",
            "btn_text" : "AI Chat Bot",
            "btn_tooltip" : "AI Chat Bot",
            "show_top" : True,
            "is_active" : False
        },
    ...
    def setup_gui(self):
        ...
        if self.settings["custom_title_bar"]:
            ...
            self.ui.title_bar.set_title("Welcome to Fluxor")
        ...
        # # PUSH BUTTON 1
        self.push_button_select_dir = PyPushButton(
        ...
        self.push_button_select_dir.setMinimumHeight(40)
        self.push_button_select_dir.clicked.connect(self.select_directory)

        # Directory tree Widget
        self.directory_contents = DirectoryContentsWidget(
            radius = 8,
            color = self.themes["app_color"]["text_foreground"],
            bg_color = self.themes["app_color"]["bg_one"],
            selection_color = self.themes["app_color"]["bg_three"],
            header_horizontal_color = self.themes["app_color"]["dark_one"],
            header_vertical_color = self.themes["app_color"]["bg_three"],
            bottom_line_color = self.themes["app_color"]["bg_three"],
            grid_line_color = self.themes["app_color"]["bg_three"],
            scroll_bar_bg_color = self.themes["app_color"]["bg_one"],
            scroll_bar_btn_color = self.themes["app_color"]["dark_four"],
            context_color = self.themes["app_color"]["context_color"]
        )

        # processed dir tree widget
        self.proceesed_directory_contents = DirectoryContentsWidget(
            radius = 8,
            color = self.themes["app_color"]["text_foreground"],
            bg_color = self.themes["app_color"]["bg_one"],
            selection_color = self.themes["app_color"]["bg_three"],
        ...
        self.line_edit = PyLineEdit(
            text = "",
            place_holder_text = "Place your coustom text to classify your contents",
            radius = 8,
            border_size = 2,
            color = self.themes["app_color"]["text_foreground"],
        ...
        # Execute the ai code
        self.push_button_execute = PyPushButton(
            text="Execute",
            radius=8,
            color=self.themes["app_color"]["text_foreground"],
            bg_color=self.themes["app_color"]["dark_one"],
        ...
        self.push_button_execute.setMinimumHeight(40)
        self.push_button_execute.clicked.connect(self.classify_execute)


        #implement the ai code
        self.push_button_implement = PyPushButton(
            text="Implement",
            radius=8,
            color=self.themes["app_color"]["text_foreground"],
            bg_color=self.themes["app_color"]["dark_one"],
        ...
        self.push_button_implement.setMinimumHeight(40)
        self.push_button_implement.clicked.connect(self.handle_implement_button)

        button_widget = QWidget()
        button_layout = QHBoxLayout(button_widget)
        # Add the buttons to the layout
        button_layout.addWidget(self.push_button_execute)
        button_layout.addWidget(self.push_button_implement)
        ...
        # self.ui.load_pages.row_1_layout.addWidget(self.push_button_1)
        self.ui.load_pages.row_1_layout.addWidget(self.push_button_select_dir)
        self.ui.load_pages.row_2_layout.addWidget(self.directory_contents)
        self.ui.load_pages.row_2_layout.addWidget(self.proceesed_directory_contents)
        ...
        self.ui.load_pages.row_4_layout.addWidget(button_widget)
        ...
        self.push_button_select_dir.setMinimumHeight(40)
        self.push_button_select_dir.clicked.connect(self.select_directory_page3)

        self.push_button_select_file = PyPushButton(
            text="Select Files",
            radius=8,
            color=self.themes["app_color"]["text_foreground"],
            bg_color=self.themes["app_color"]["dark_one"],
        ...
        self.push_button_select_file.setMinimumHeight(40)
        self.push_button_select_file.clicked.connect(self.select_file_page3)


        self.name_comaprision = DirectoryContentsWidget(
            radius = 8,
            color = self.themes["app_color"]["text_foreground"],
            bg_color = self.themes["app_color"]["bg_one"],
            selection_color = self.themes["app_color"]["bg_three"],
        ...
        self.name_comaprision.set_custom_headers("rename")

        # Execute the ai code
        self.push_button_execute_2 = PyPushButton(
            text="Execute",
            radius=8,
            color=self.themes["app_color"]["text_foreground"],
            bg_color=self.themes["app_color"]["dark_one"],
        ...
        self.push_button_execute_2.setMinimumHeight(40)
        self.push_button_execute_2.clicked.connect(self.rename_files)


        #implement the ai code
        self.push_button_implement_2 = PyPushButton(
            text="Implement",
            radius=8,
            color=self.themes["app_color"]["text_foreground"],
            bg_color=self.themes["app_color"]["dark_one"],
        ...
        self.push_button_implement_2.setMinimumHeight(40)
        self.push_button_implement_2.clicked.connect(self.implement_renaming)

        button_widget_2 = QWidget()
        button_layout = QHBoxLayout(button_widget_2)
        # Add the buttons to the layout
        button_layout.addWidget(self.push_button_execute_2)
        button_layout.addWidget(self.push_button_implement_2)

        button_layout.setAlignment(Qt.AlignRight)
        button_layout.setContentsMargins(10, 10, 10, 10)

        # # ADD WIDGETS
        self.ui.load_pages.row_1_layout_3.addWidget(self.push_button_select_dir)
        self.ui.load_pages.row_1_layout_3.addWidget(self.push_button_select_file)
        self.ui.load_pages.row_2_layout_3.addWidget(self.name_comaprision)
        self.ui.load_pages.row_3_layout_3.addWidget(button_widget_2)


        
        # Sorting based on File Type
        # ///////////////////////////////////////////////////////////////
        self.page4_select_directory = PyPushButton(
            text="Select Directory",
            radius=8,
            color=self.themes["app_color"]["text_foreground"],
            bg_color=self.themes["app_color"]["dark_one"],
        ...
        self.page4_select_directory.setMinimumHeight(40)
        self.page4_select_directory.clicked.connect(self.select_directory_page4)

        self.page4_show_dir = DirectoryContentsWidget(
            radius = 8,
            color = self.themes["app_color"]["text_foreground"],
            bg_color = self.themes["app_color"]["bg_one"],
            selection_color = self.themes["app_color"]["bg_three"],
        ...
        self.page4_show_dir_2 = DirectoryContentsWidget(
            radius = 8,
            color = self.themes["app_color"]["text_foreground"],
            bg_color = self.themes["app_color"]["bg_one"],
            selection_color = self.themes["app_color"]["bg_three"],
        ...
        # Execute button on sorting based on type
        self.push_button_execute_3 = PyPushButton(
            text="Execute",
            radius=8,
            color=self.themes["app_color"]["text_foreground"],
            bg_color=self.themes["app_color"]["dark_one"],
        ...
        self.push_button_execute_3.setMinimumHeight(40)
        self.push_button_execute_3.clicked.connect(self.execute_Sort_files_type)


        #implement button on sorting based on type
        self.push_button_implement_3 = PyPushButton(
            text="Implement",
            radius=8,
            color=self.themes["app_color"]["text_foreground"],
            bg_color=self.themes["app_color"]["dark_one"],
        ...
        self.push_button_implement_3.setMinimumHeight(40)
        self.push_button_implement_3.clicked.connect(self.implement_sort_file_type)

        button_widget_3 = QWidget()
        button_layout = QHBoxLayout(button_widget_3)
        button_layout.addWidget(self.push_button_execute_3)
        button_layout.addWidget(self.push_button_implement_3)
        button_layout.setAlignment(Qt.AlignRight)
        button_layout.setContentsMargins(10, 10, 10, 10)
        

        self.ui.load_pages.row_1_layout_4.addWidget(self.page4_select_directory)
        self.ui.load_pages.row_2_layout_4.addWidget(self.page4_show_dir)
        self.ui.load_pages.row_2_layout_4.addWidget(self.page4_show_dir_2)
        self.ui.load_pages.row_3_layout_4.addWidget(button_widget_3)
        
        #page5 AI chatbot

        self.ui.load_pages.select_dir_button.clicked.connect(self.select_directory_page5)
        self.ui.load_pages.send_button.clicked.connect(self.send_message)
